#!/usr/bin/env python
"""
Финальный скрипт для создания реальных товаров
"""
import os
import django
import random
...
def create_real_products():
    ...
    with connection.cursor() as cursor:
        ...
        products = [
            ...
            {"name": "OnePlus 12", "price": 79990, "category": "Смартфоны"},
            {"name": "Google Pixel 8 Pro", "price": 99990, "category": "Смартфоны"},
            ...
            {"name": "Dell XPS 13", "price": 129990, "category": "Ноутбуки"},
            {"name": "HP Spectre x360", "price": 109990, "category": "Ноутбуки"},
            ...
            {"name": "Пылесос Dyson V15", "price": 49990, "category": "Бытовая техника"},
            {"name": "Микроволновка Bosch", "price": 19990, "category": "Бытовая техника"},
            ...
            {"name": "Блузка женская офисная", "price": 2990, "category": "Одежда"},
            {"name": "Свитер вязаный", "price": 5990, "category": "Одежда"},
            ...
            {"name": "Сапоги зимние", "price": 11990, "category": "Обувь"},
            {"name": "Сандалии летние", "price": 3990, "category": "Обувь"},
            ...
            {"name": "Беговая дорожка", "price": 89990, "category": "Спорт"},
            {"name": "Гиря 16кг", "price": 2990, "category": "Спорт"},
            {"name": "Война и мир Л.Н. Толстой", "price": 890, "category": "Книги"},
            {"name": "Гарри Поттер и философский камень", "price": 1290, "category": "Книги"},
            {"name": "Атлас мира", "price": 2990, "category": "Книги"},
            {"name": "Словарь русского языка", "price": 1990, "category": "Книги"},
            {"name": "Энциклопедия животных", "price": 3990, "category": "Книги"},
            ...
            {"name": "Шкаф-купе", "price": 59990, "category": "Мебель"},
            {"name": "Кровать двуспальная", "price": 29990, "category": "Мебель"},
            {"name": "Крем для лица La Mer", "price": 45990, "category": "Красота"},
            {"name": "Парфюм Chanel №5", "price": 12990, "category": "Красота"},
            {"name": "Шампунь профессиональный", "price": 1990, "category": "Красота"},
            {"name": "Маска для лица", "price": 2990, "category": "Красота"},
            {"name": "Сыворотка для волос", "price": 3990, "category": "Красота"},
            ...
            {"name": "Ингалятор", "price": 4990, "category": "Здоровье"},
            {"name": "Массажер для ног", "price": 5990, "category": "Здоровье"},
        ]
